...
class _WindowEditQuestionState extends State<WindowEditQuestion> {
                ...
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _numberAndPoinSection(context, availableNumbers, dropdownNumber, isDark),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Perbarui butir pertanyaan atau kunci jawaban',
                  style: TextStyle(
  ...
  Widget _numberAndPoinSection(BuildContext context, List<int> availableNumbers, int? dropdownNumber, bool isDark) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Row(
